...
`ModelDataRequirements`, `ReadingsDataSource` and `AssetQuery`.
...
The `get_data` method should return a dataframe-like object.
...
1) Go to the <a href="https://jira.uptake.com/">Uptake's JIRA portal</a> and log in with your Uptake credentials and visit the dashboard. 

2) On the top section of the page, you can find an option `Create`. Click on it.
